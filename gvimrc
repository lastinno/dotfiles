...
if has('win32') || has('win64')
  " Windows用
  set guifont=Ricty\ Discord\ 12,Consolas:h10,Lucida_Console:h10:w5 
  "set guifontwide=Osaka－等幅:h12
  "set guifontwide=MS_Mincho:h12:cSHIFTJIS
  set guifontwide=Discord\ 12,MS_Gothic:h10
  set encoding=utf8
